    ...
    try:
        with sync_playwright() as p:
            ...
            for pg in range(1, pages + 1):
                if pg == 1:
                    url = f"https://www.naukri.com/{clean_query}-jobs?k={encoded_k}&jobAge={job_age}&experience={experience}"
                else:
                    url = f"https://www.naukri.com/{clean_query}-jobs-{pg}?k={encoded_k}&jobAge={job_age}&experience={experience}"
